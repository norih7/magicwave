      ...
      <ul>
        {items.map((item, index) => (
          <li key={index} className="mb-2">
            <a
              href={item.href}
              className="flex items-center p-2 text-sm text-gray-900 bg-gray-50 border border-gray-200 rounded-sm transition-all duration-200 hover:bg-blue-100 hover:text-blue-700 hover:border-blue-300"
            >
